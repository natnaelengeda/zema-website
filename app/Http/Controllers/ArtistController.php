...
class ArtistController extends Controller
{
   ...
   public function profile(Request $request)
   {
      ...
      $info = ['fname' => $dbs->fname, 'lname' => $dbs->lname, 'uname' => $dbs->uname, 'email' => $dbs->email, 'phonenumber' => $dbs->phonenumber, 'uploadmusic' => $dbs->musicUpload, 'uploadalbum' => $dbs->albumUpload, 'profilepic' => $dbs->profilepic, 'musics' => $musicnum, 'follow' => 2];
   ...
   public function uploadmusicpage(Request $request)
   {
      ...
      $musicnum = count($musics);
      // $follow = DB::table('follow_artists')->where('artist_id', $id)->get();
      $info = ['fname' => $dbs->fname, 'lname' => $dbs->lname, 'uname' => $dbs->uname, 'email' => $dbs->email, 'phonenumber' => $dbs->phonenumber, 'uploadmusic' => $dbs->musicUpload, 'uploadalbum' => $dbs->albumUpload, 'profilepic' => $dbs->profilepic, 'musics' => $musicnum, 'follow' => 1];
   ...
   public function viewmusicfun(Request $request)
   {
      ...
      // $follow = DB::table('follow_artists')->where('artist_id', $id)->get();
      $info = ['fname' => $dbs->fname, 'lname' => $dbs->lname, 'uname' => $dbs->uname, 'email' => $dbs->email, 'phonenumber' => $dbs->phonenumber, 'uploadmusic' => $dbs->musicUpload, 'uploadalbum' => $dbs->albumUpload, 'profilepic' => $dbs->profilepic, 'musics' => $musicnum, 'follow' => 3];
