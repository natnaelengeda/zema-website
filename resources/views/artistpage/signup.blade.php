    ...
    <div class=" w-1/2 h-full py-7">
            ...
            <div class="w-[90%] m-auto mt-10 h-auto">
                <x-auth-validation-errors class="mb-4" :errors="$errors" />  
                        <form method="POST" action="/asignup" enctype="multipart/form-data">
                            @csrf
                        ...
                        {{-- Profile Picture --}}
                        <div class="mb-6">                       
                            <label class="block mb-2 text-sm font-medium text-gray-900 :text-gray-300" for="musicpic">Profile Picture:</label>
                            ...
                            <div class="mt-1 text-sm text-gray-500 :text-gray-300" id="user_avatar_help">Choose a profile to be displayed</div>
                            </div>
                         {{-- Username  --}}
                         <div class="relative z-0 w-full mb-6 group">
