<section class=>
    <div class="music-container border border-gray-200 shadow-2xl z-40 bg-white flex h-28 fixed bottom-0 rounded-xl overflow-hidden right-0" id="music-container">
